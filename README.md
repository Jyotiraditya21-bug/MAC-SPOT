...
- **about**: Displays developer/owner details of MAC-SPOT (also available as `owner` and `builder`).
...
For a separate document, see the [CLI Commands Reference Guide](file:///Users/jimmycodes/MAC-SPOT/docs/commands_list.md).
